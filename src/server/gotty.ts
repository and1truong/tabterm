...
const ZSHENV_SHIM = [
  ...
  "# Their .zshenv may itself set ZDOTDIR (prezto/zimfw); carry the effective",
  "# value forward so our .zshrc sources their config from the right dir.",
  'export _TABTERM_HOME_ZDOTDIR="${ZDOTDIR:-}"',
